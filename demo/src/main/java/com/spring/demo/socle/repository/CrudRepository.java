package com.spring.demo.socle.repository;

import com.spring.demo.socle.exception.EntiteNonConnueException;
...
import static com.spring.demo.socle.utils.CollectionUtils.isNullOrEmpty;
